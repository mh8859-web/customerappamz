...
export const ShieldCheckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A12.02 12.02 0 0012 22c4.646 0 8.57-2.943 10.04-7.016a5.993 5.993 0 00-2.422-6.038z" />
    </svg>
);
...
export const MegaphoneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V4.5a1.5 1.5 0 013 0v1.382m-3 0a1.5 1.5 0 00-1.06 2.574l-3.337 3.338a1.5 1.5 0 000 2.122l3.337 3.338a1.5 1.5 0 001.06 2.574m-3 0a1.5 1.5 0 01-1.06-2.574l-3.337-3.338a1.5 1.5 0 010-2.122l3.337-3.338a1.5 1.5 0 011.06-2.574m3 0a7.5 7.5 0 100 15 7.5 7.5 0 000-15z" />
    </svg>
);
...
export const ShareIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08m0 0a2.25 2.25 0 11-2.25 2.25m2.25-2.25c0 .198.025.39.07.582m0 0c.044.19.096.374.155.55M15 4.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm0 0c.195.025.39.05.588.08m0 0a2.25 2.25 0 11-2.25 2.25m2.25-2.25c0 .198.025.39.07.582m0 0c.044.19.096.374.155.55m-5.292 6.75a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08m0 0a2.25 2.25 0 11-2.25 2.25m2.25-2.25c0 .198.025.39.07.582m0 0c.044.19.096.374.155.55M3 4.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm0 0c.195.025.39.05.588.08m0 0a2.25 2.25 0 11-2.25 2.25m2.25-2.25c0 .198.025.39.07.582m0 0c.044.19.096.374.155.55m12.75 6.75a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08m0 0a2.25 2.25 0 11-2.25 2.25m2.25-2.25c0 .198.025.39.07.582m0 0c.044.19.096.374.155.55" />
  </svg>
);
...
export const BuildingOffice2Icon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m7.692-7.693l-7.693 7.693-2.48-2.48" />
  </svg>
);

export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118v-.007a2.25 2.25 0 01-.501-4.438 3 3 0 005.78-1.128 2.25 2.25 0 012.47-2.118v.007a2.25 2.25 0 01.501 4.438z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 10.5v1.875a.375.375 0 00.375.375h1.875a.375.375 0 00.375-.375V10.5m-2.25 0h.008v.008h-.008V10.5z" />
  </svg>
);
...
export const PinIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75V16.5L12 14.25 7.5 16.5V3.75m9 0H12m4.5 0H12m0 0H7.5m4.5 0v.008" />
    </svg>
);
...
export const ThumbUpIcon: React.FC<IconWithSolidProps> = ({ className, solid }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill={solid ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 00-.75-.75A2.25 2.25 0 0016.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282H18a2.25 2.25 0 012.25 2.25v3.75A2.25 2.25 0 0118 17.25H6.75A2.25 2.25 0 014.5 15V6.75A2.25 2.25 0 016.75 4.5H8.25a.75.75 0 010 1.5H6.75a.75.75 0 00-.75.75v8.25a.75.75 0 00.75.75h8.25a.75.75 0 00.75-.75v-2.25a.75.75 0 00-.75-.75h-1.372c-.879 0-1.708-.474-2.164-1.223-.455-.748-.455-1.688 0-2.436a3.752 3.752 0 012.86-1.33c.345 0 .67.067.968.2a1.125 1.125 0 011.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125H15a.75.75 0 01-.75-.75v-1.5a.75.75 0 00-.75-.75H12a.75.75 0 00-.75.75v1.5a.75.75 0 01-.75.75H9.333a.75.75 0 01-.75-.75V10.5z" />
  </svg>
);
