...
const Login: React.FC = () => {
  ...
  // If auth check is complete and a user exists, redirect away.
  if (!authLoading && user) {
  ...
  // Render nothing during the initial auth check to prevent flicker.
  // The ProtectedRoute logic will handle the final state.
  if (authLoading) {
      return null;
  }
