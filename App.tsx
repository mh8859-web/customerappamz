...
// --- NEW APP SHELL ---
// Renders an instant, static skeleton of the app UI while authentication is checked.
// This eliminates the blank loading screen and makes the app feel incredibly fast.
const AppShell = () => (
...
const App: React.FC = () => {
  ...
  // Show the instant App Shell during the initial authentication check.
  if (authLoading) {
    return <AppShell />;
  }
